...
; Endstops
M574 X1 "Pxstop" S1		                    ; Set endstop position [XY: Low-End (1), Active-high (S1)]
M574 Y1 "Pystop" S1		                    ; Set endstop position [XY: Low-End (1), Active-high (S1)]
...
; Print Fan
M950
; M106 P1 S1 I0 F500 H1 T45 C"Tool-Fan"       ; Set fan 1 name, value, PWM signal inversion and frequency. Thermostatic control is turned off
; Part Cooling Fan
M950
...
; G31 X0 Y30 Z2.00 P500			                ; Set Probe status 
