...
; Mini IR
M558 P1 C"^io7.in" H5 F120 T7200 A3 S0.02                                   ; Set Z probe type [P1:MiniIR, (F)eedrate:120mm/min, Dive-(H)eight:5mm, (T)ravel:7200mm/min, 3 probes per point, 0.02mm tolerance]
G31 P500 X0 Y0 Z2.5                                                         ; Set Z probe trigger value, offset and trigger height
M557 X15:280 Y35:260 P3:3                      	                            ; Define mesh grid

; Heated Bed Settings
M308 S0 P"temp0" Y"thermistor" A"Keenovo" T100000 B3950 R4700               ; configure sensor 0 as thermistor on pin temp0
